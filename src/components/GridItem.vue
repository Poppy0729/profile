    ...
    const articles = [
      {
        ...
        title: 'Mastering iOS Development: Top Tips and Tricks',
      ...
      },
      {
        ...
        author: 'Poppy Shutter',
        title: 'Backend Solutions: Enhancing Performance and Security',
      ...
      },
      {
        ...
        author: 'Poppy Shutter',
        title: 'Exploring the World of Cross-Platform Development',
